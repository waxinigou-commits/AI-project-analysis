...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <main>
      <section className="hero"><div><p className="eyebrow">AI COMMERCIAL INTELLIGENCE</p><h1>发现下一个<br/><em>商业信号</em></h1><p className="hero-copy">追踪全球 AI 新产品。原始事实逐条关联来源，商业判断明确标记为分析，不把推断伪装成事实。</p></div><div className="hero-side"><div className="pulse"><span>VERIFIED</span><div className="orb">{products.length}</div><p>已核验产品</p></div><div className="updated"><span>最后核验</span><b>{lastVerified}</b></div></div></section>
